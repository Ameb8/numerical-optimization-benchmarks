...
\sum_{i=1}^{n-1}
\left[
\frac{1}{e^{0.2}} \sqrt{x_i^2 + x_{i+1}^2}
+ 3\left(\cos(2x_i) + \sin(2x_{i+1})\right)
\right]
\]
...
\left[
20 + e
- 20 e^{-0.2 \sqrt{\frac{x_i^2 + x_{i+1}^2}{2}}}
- e^{0.5\left[\cos(2\pi x_i) + \cos(2\pi x_{i+1})\right]}
\right]
\]
...
\sum_{i=1}^{n-1}
\left[
- x_i \sin\left(\sqrt{|x_i - x_{i+1} - 47|}\right)
- (x_{i+1} + 47)
\sin\left(\sqrt{\left|x_{i+1} + 47 + \frac{x_i}{2}\right|}\right)
\right]
\]
...
\[
f_5(\mathbf{x}) = 1 + \sum_{i=1}^{n} \frac{x_i^2}{4000}
...
\[
f_4(\mathbf{x}) = 10n + \sum_{i=1}^{n} \left[ x_i^2 - 10\cos(2\pi x_i) \right]
\]
...
\[
f_3(\mathbf{x}) = \sum_{i=1}^{n-1} \left[ 100\left(x_i^2 - x_{i+1} \right)^2 + (1 - x_i)^2 \right]
\]
...
f_6(\mathbf{x}) =
- \sum_{i=1}^{n-1}
0.5 + \frac{\sin^2\left(x_i^2 + x_{i+1}^2 - 0.5\right)}
{\left[1 + 0.001\left(x_i^2 + x_{i+1}^2\right)\right]^2}
\]
...
\sum_{i=1}^{n-1}
\left[
\left(x_i^2 + x_{i+1}^2\right)^{1/4}
\sin^2\left(50\left(x_i^2 + x_{i+1}^2\right)^{1/10}\right)
+ 1
\right]
\]
